    ...
    ui(new Ui::MainWindow)
{
    ...
    QVector<QPushButton *> hero_button, hero_button1, hero_button2, hero_button3, hero_button4, hero_button5, hero_button6;
...
void MainWindow::hero_ability_show()
{
    ...
    QVector<QStringList> rank = hero_list;
    ...
    //ui->textBrowser_tips->setText(hero_sugg[rank[arr[0]][0].toInt()][0]+": "+hero_sugg[rank[arr[0]][0].toInt()][1]);
...
void MainWindow::hero_initialize(QVector<QPushButton *> &hero_button, QVector<QPushButton *> &hero_button1, QVector<QPushButton *> &hero_button2, QVector<QPushButton *> &hero_button3, QVector<QPushButton *> &hero_button4, QVector<QPushButton *> &hero_button5, QVector<QPushButton *> &hero_button6)
{
    ...
    while (!data_file->atEnd()){
        ...
        QPixmap pixmap = QPixmap("D:/kCal/data_processing/heropng/"+pngname+".jpg").scaled(button->size(),Qt::KeepAspectRatio);
...
void MainWindow::on_comboBox1_currentIndexChanged(int index)
{
    ...
    QPixmap pixmap = QPixmap("D:/kCal/data_processing/heropng/"+pngname+".jpg").scaled(ui->label_vsjpg1->size(),Qt::KeepAspectRatio);
