...
QVector<QPushButton *> hero_button;
QVector<QPushButton *> hero_button1;
QVector<QPushButton *> hero_button2;
QVector<QPushButton *> hero_button3;
QVector<QPushButton *> hero_button4;
QVector<QPushButton *> hero_button5;
QVector<QPushButton *> hero_button6;
QVector<QStringList> hero_list;
QVector<int> rank1, rank2, rank3, rank4;
...
QString background = "D:/kCal/data_processing/heroskin/106-小乔-恋之微风.jpg";
//输入
QString text1= "";
//输出
QString text2= "";
...
void MainWindow::hero_initialize()
{
    ...
    qDebug()<<arr[0]<<arr[1]<<arr[2]<<arr[3]<<arr[4]<<arr[5];
    ...
    //pLayout1->setVerticalSpacing(0);
    //pLayout2->addWidget(label, count1/8, count1%8);
    //pLayout3->addWidget(label, count1/8, count1%8);
    //pLayout4->addWidget(label, count1/8, count1%8);
    //pLayout5->addWidget(label, count1/8, count1%8);
    //pLayout6->addWidget(label, count1/8, count1%8);
